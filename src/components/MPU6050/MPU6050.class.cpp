...
uint8_t MPU6050::getQuaternion(int16_t *data, const uint8_t* packet)
{
    if (packet == 0)
...
uint8_t MPU6050::getQuaternion(Quaternion *q, const uint8_t* packet)
{
    int16_t qI[4];
...
uint8_t MPU6050::getGravity(VectorFloat *v, Quaternion *q)
{
...
uint8_t MPU6050::getYawPitchRoll(float *data, Quaternion *q, VectorFloat *gravity)
{
...
uint8_t MPU6050::getYawPitchRoll(float *data)
{
...
uint16_t MPU6050::getFIFOPacketSize()
{
...
int8_t MPU6050::i2cReadBits(uint8_t regAddr, uint8_t bitStart, uint8_t length, uint8_t *data)
{
    uint8_t count, b;
...
int8_t MPU6050::i2cReadBytes(uint8_t regAddr, uint8_t length, uint8_t *data)
{
    int8_t count = 0;
...
bool MPU6050::i2cWriteBits(uint8_t regAddr, uint8_t bitStart, uint8_t length, uint8_t data)
{
    uint8_t b;
...
bool MPU6050::i2cWriteBytes(uint8_t regAddr, uint8_t length, uint8_t* data)
{
    int8_t count = 0;
    uint8_t buf[128];
...
bool MPU6050::i2cWriteWords(uint8_t regAddr, uint8_t length, uint16_t* data)
{
    int8_t count = 0;
    uint8_t buf[128];
